...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,        90, 20, 100
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,       0, FIGHTING,     100, 20,   0
	...
	move ABSORB,       EFFECT_LEECH_HIT,          20, GRASS,        100, 25,   0 ; OLD PP: 20
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          40, GRASS,        100, 15,   0 ; OLD PP: 10
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,         90, 10,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, NORMAL,       100, 20,   0 ; OLD PP: 40
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,           120, GRASS,        100, 10,   0 ; OLD POWER: 70, OLD PP: 20
	move STRING_SHOT,  EFFECT_SPEED_DOWN_2,        0, BUG,           95, 40,   0 ; OLD: EFFECT_SPEED_DOWN
	...
	move DIG,          EFFECT_FLY,                80, GROUND,       100, 10,   0 ; OLD POWER: 60
	move TOXIC,        EFFECT_TOXIC,               0, POISON,        90, 10,   0 ; OLD ACCURACY: 85
	...
	move LICK,         EFFECT_PARALYZE_HIT,       30, GHOST,        100, 30,  30 ; OLD POWER: 20
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        130, NORMAL,       100, 10,   0 ; OLD POWER: 100, OLD PP: 15
	...
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,       100, 30,   0 ; OLD ACCURACY: 75
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE,      100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        90, 40,   0 ; OLD ACCURACY: 55
	...
	move FLASH,        EFFECT_ACCURACY_DOWN,       0, NORMAL,       100, 20,   0 ; OLD ACCURACY: 70
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_TYPE,      100, 15,   0 ; OLD ACCURACY: 80
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,       100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,       100, 20,   0 ; OLD PP: 40
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, WATER,         90, 10,   0 ; OLD POWER: 90, OLD ACCURACY: 85
	...
	move SNORE,        EFFECT_SNORE,              50, NORMAL,   100, 15,  30 ; OLD POWER: 40
	...
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, NORMAL,   100, 10,   0 ; OLD ACCURACY: 90
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,  50,  5, 100 ; OLD POWER: 100
	...
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,    90, 10,   0 ; OLD ACCURACY: 80
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,   100,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,   100, 10,   0 ; OLD POWER: 90, OLD PP: 15
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,     100, 10,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          75, GRASS,    100, 10,   0 ; OLD POWER: 60, OLD PP: 5
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        40, BUG,       95, 20,   0 ; OLD POWER: 10
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  100, 10,   0 ; OLD POWER: 80, OLD ACCURACY: 90, OLD PP: 15
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   40, FIGHTING, 100, 15,  50 ; OLD POWER: 20
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        35, WATER,     85, 15, 100 ; OLD POWER: 15, OLD ACCURACY: 70
	move BEAT_UP,      EFFECT_BEAT_UP,             0, DARK,     100, 10,   0 ; OLD POWER: 10
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,        100, 15,   0
	move DAZZLINGLEAM, EFFECT_NORMAL_HIT,         80, FAIRY,        100, 10,   0
	move PLAYROUGH,    EFFECT_ATTACK_DOWN_HIT,    90, FAIRY,         90, 10,   0
